% HEATMAPS  Plot condition heatmaps from a saved analysis workspace [template].
%   Loads a previously-saved workspace (.mat) and draws heatmaps of marker
%   responses across a grid of conditions (e.g. Activin x CHIR). Edit the loaded
%   workspace file and the condition-label arrays near the top.
clear all; close all;

% ANALYZE_FIXED_INTEGRATED  Fixed-data analysis driver (MP or disordered) [template].
%   End-to-end analysis of a fixed experiment: set up metadata (channels,
%   conditions), build Position/Colony objects, quantify, and plot integrated
%   results. Set imageType ('MP'/'Disordered') and manMeta near the top; run

% SINGLECELLQUANTIFICATIONLIVE  Single-cell quantification for live time-lapse data [template].
%   Iterates over positions, time points and channels, reading per-cell
%   intensities into a time-indexed cellData on each Position, and saves
%   positions.mat. Edit imageType/radii/segDir near the top; run from the data dir.
clear; close all; clc

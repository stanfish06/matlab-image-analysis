...
%WRITEFUSIONPROTOCOL Write a Fusion acquisition protocol with updated positions.
%   LINES = WRITEFUSIONPROTOCOL(PROTOCOLFILE, PROTOCOL) reads the existing
%   Fusion protocol PROTOCOLFILE and writes a new <name>_NEW.bkp file in which
%   the stage positions are replaced by those in PROTOCOL (XYZ + AFoffset).

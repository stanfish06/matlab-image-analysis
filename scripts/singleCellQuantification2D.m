% SINGLECELLQUANTIFICATION2D  Single-cell quantification for 2-D data [template].
%   2-D variant of the quantification template: reads masks + images, builds the
%   Position/Colony array with per-cell cellData and saves positions.mat. Edit
%   the setup block (dirs, imageType, radii) and run from the data directory.
clear; close all; clc

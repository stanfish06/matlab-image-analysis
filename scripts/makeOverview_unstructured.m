...
% MAKEOVERVIEW_UNSTRUCTURED  Overview montage from unstructured filenames [template].
%   Like MAKEOVERVIEW but for files not named by well/plate layout (e.g.
%   *FusionStitcher.ims): builds the file list directly from the folder. Edit the
%   listing pattern and channel labels near the top.
clear all; close all;

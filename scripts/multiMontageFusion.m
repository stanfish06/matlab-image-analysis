% MULTIMONTAGEFUSION  Generate a multi-montage Fusion protocol (plane-fit z) [template].
%   Reads a Fusion protocol (.bkp) and builds montage grids of stage positions
%   for many fields, fitting z to a plane from several points for uneven plates.
%   Edit protocolFile, resolution, gridSize, montageOverlap and pointsPerGrid.
clear all; close all;

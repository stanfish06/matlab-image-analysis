function G = create_tracks_v3(this, opts)
%%%% Inputs %%%%
...
parfor ti=1:tmax - 1
    ...
    sinfo.XY = points{ti}; tinfo.XY = points{ti+1};
    sinfo.angle = angles{ti};
...
[newedges, badedges, costs] = graphmergelinker(G, points, areas, Divs,...
    max_gap_time);

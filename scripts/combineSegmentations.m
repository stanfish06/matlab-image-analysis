% COMBINESEGMENTATIONS  Combine Ilastik/Cellpose segmentations into nuc/cyt masks [template].
%   Loads meta.mat and consolidates segmentations (segmode 'ilastik'/'cellpose'/
%   'combined') into cleaned nuclear and cytoplasmic masks, with size filtering
%   and convex decomposition to split fused nuclei. Edit segmode and the
%   area/decomposition options near the top.
clear; close all; clc

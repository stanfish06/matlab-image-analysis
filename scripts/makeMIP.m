% MAKEMIP  Preprocessing driver: build metadata, MIPs and stitched images [template].
%   Constructs a Metadata object (with manualMeta: nWells, posPerCondition,
%   montage grid/overlap), saves meta.mat, and runs preprocessing (MIPs and/or
%   stitching per stitchOptions). Edit the metadata and stitch/MIP options near
%   the top, then run from the raw-data directory.
clear all; close all;

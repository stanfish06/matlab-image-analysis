% SUMCHANNELS  Sum selected channels of MIP images [template].
%   Lists MIP files for the chosen channels and writes their per-pixel sum. Edit
%   `channels` (which channels to sum) near the top; run from the data directory
%   (uses the MIP/ subfolder).
clear all; close all;

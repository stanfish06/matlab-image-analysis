% ANALYZE_WITHTRACKING  Driver script: live-imaging analysis with tracking [script].
%   Interactive analysis script for a live (time-lapse) dataset. Set dataDir
%   and manual metadata (nPositions, conditions, channels, nTime, ...), then run
%   to segment, extract per-frame cellData, track cells over time and build
%   signaling traces. Edit the parameters near the top for your experiment.
clear; close all;

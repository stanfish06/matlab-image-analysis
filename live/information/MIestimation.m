% Mutual-information / entropy estimation examples [script].
%   Interactive script demonstrating the information-theoretic estimators used
%   for signaling analysis: Monte-Carlo vs Riemann integration, N-D Gaussian
%   integrals, and mutual-information estimation. Run section by section.
clear all; close all;

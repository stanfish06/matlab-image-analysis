...
% MAKEOVERVIEW  Build a per-condition overview montage from raw images [template].
%   Reads raw .ims files organized by plate layout (well-coded filenames), picks
%   a representative file per well, and builds an overview montage across
%   conditions. Edit the `conditions` table and channel labels near the top.
clear all; close all;

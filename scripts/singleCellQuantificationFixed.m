% SINGLECELLQUANTIFICATIONFIXED  Single-cell quantification for fixed data [template].
%   Reads masks + images and builds the Position/Colony array with per-cell
%   cellData for a fixed (endpoint) experiment, saving positions.mat. Edit the
%   setup block (dirs, imageType, radii) and run from the data directory.
clear; close all; clc

...
%SIMULATECELLS Generate synthetic cell-movie data for testing tracking.
%   [P, TREES, SIM_POINTS] = SIMULATECELLS(NUMCELLS, NTIMEPOINTS, DIVISION_FREQ,
%   SEGMENT_ERRORS, VELOCITY, INTENSITY_DRIFT, IMSIZE, BUFFER) simulates NUMCELLS
%   cells over NTIMEPOINTS frames with random motion, divisions, intensity drift
%   and segmentation errors. Returns a Position object P, the ground-truth
%   lineage TREES, and the per-frame point data SIM_POINTS. A known-truth
%   benchmark for the tracking linkers.
